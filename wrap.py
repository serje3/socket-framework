...
def render_css(css_file):
    ...
    with open(css_file, encoding='utf-8') as temp:
        ...
        return css_doc
    # Заметка для фикса
    # Когда не существует такого пути к файлу css, он - крашится, нужно сделать try except FileNotFoundError,
    # который в except будет удалять такой путь из базы данных
